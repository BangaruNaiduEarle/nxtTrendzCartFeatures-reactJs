...
class App extends Component {
  ...
  deleteCartItem = id => {
    ...
    const updatedCardList = cartList.filter(each => each.id !== id)
  ...
  addCartItem = product => {
    ...
    const alreadyAdded = cartList.find(each => each.id === product.id)
    ...
    return (
      <CartContext.Provider
        value={{
          ...
          removeAllCartItems: this.onClickRemoveAllCartItems,
